...
- [-] Apply the same logic as 3DSS for reticle positioning
  ...
  - [ ] Construct transposed rotation matrix to apply skew to reticle
  - [ ] Figure out why position is offset
    - Perhaps due to working in screen space instead of tangent space?
